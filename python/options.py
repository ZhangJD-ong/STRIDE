...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        #Hyperparamter required your attention
        parser.add_argument('--datapath', default=r'./data', help='path of the raw data')
        parser.add_argument('--task_name', type=str, default='Demo_Calcium', help='the current task name')
        parser.add_argument('--image_type', type=str, default='xyt', help="xyt for functional imaging and xyz for structural imaging")
        ...
        parser.add_argument('--inference_mode', type=bool, default=True, help="2D_center for denoising inference of functional imaging")
