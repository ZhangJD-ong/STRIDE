...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--inference_mode_2D', type=bool, default=True, help="2D_center for denoising inference of functional imaging")
        parser.add_argument('--iter_num', type=int, default=1, help="iterations in the inference stage")
        parser.add_argument('--train_datasets_size', type=int, default=6000, help="total number of training samples (patches)")
        ...
        parser.add_argument('--datapath', default=r'./plugins/STRIDE/Raw_data', help='path of the raw data')
        parser.add_argument('--task_name', type=str, default='ImageJ_plugins', help='the current task name')
